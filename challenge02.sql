...
-- Rentals of costumer 4:
(7, 4, '2024-03-18', '2024-02-05', 650.00),
(8, 4, '2024-01-15', '2024-08-15', 300.00);

-- Spending report by customer:
...
-- Most rented cars report:
SELECT cars.id_car AS ID_Car, cars.car_brand AS Car_Brand, cars.car_model AS Car_Model, COUNT(*) AS Times_Rented 
FROM cars
